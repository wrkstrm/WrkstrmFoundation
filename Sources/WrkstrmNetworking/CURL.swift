...
public enum CURL {
  public static func command(from request: URLRequest, in environment: HTTP.Environment) -> String {
  ...
  public static func printCURLCommand(from request: URLRequest, in environment: HTTP.Environment) {
#if DEBUG
